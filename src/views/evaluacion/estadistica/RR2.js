...
function RR2Estadistica() {
    ...
    useEffect(() => {
        document.title = "ESTADISTICA RR-2";
        listarEntidades()
        return () => { }
    }, [])
    const listarEntidades = async () => {
        setTimeout(async () => {
            ...
            const data = await start(URL + '/estadistica-departamental-RR2/listar-municipios', 'Espere por favor, Cargando Parametros.')
    ...
    const listarMeses = async (gestion) => {
        const data = await start(URL + '/estadistica-departamental-RR2/listar-meses', { gestion }, 'Cargando los meses. Espere por favor !')
        setListaMeses(data)
    ...
    const buscar = async () => {
        ...
        const data = await buscarDB(URL + '/estadistica-departamental-RR2/buscar',
            {
    ...
    const listarPorComunidad = async (comunidad, gestion, mes) => {
        const lista = await start(URL + '/estadistica-departamental-RR2/listar-por-comunidad', { comunidad, gestion, mes })
        // console.log(lista)
        if (lista.length < 1) {
