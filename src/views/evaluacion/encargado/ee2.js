...
function Ee2Encargado() {
    ...
    const listarEntidades = async () => {
        const data = await start(URL + '/ee-2-encargado/listar-municipios')
    ...
    const listarMeses = async (gestion) => {
        const data = await start(URL + '/ee-2-encargado/listar-meses', { gestion }, 'Cargando los meses. Espere por favor !')
        setListaMeses(data)
    ...
    const buscar = async () => {
        ...
        const data = await buscarDB(URL + '/ee-2-encargado/buscar', 
    ...
    const listarPorComunidad = async (comunidad, gestion, mes) => {
        const listaCasa = await start(URL + '/ee-2-encargado/listar-por-comunidad', { comunidad, gestion, mes }, 'Cargando informacion, Espere por favor!')
        // console.log(lista)
