...
function DashboardEvaluador(props) {
  ...
  const filtrarEvaluaciones = async (gestion = null) => {
    ...
    const listaMeses = await start(URL + '/evaluador-ee1/filtrar-evaluaciones-viviendas', { gestion: gestion ? gestion : inputBuscar.campo }, 'Recuperando datos...')
        ...
        <Row>
          <Col lg="12">
            <Card className="card-chart">
              <CardHeader>
                <CardTitle tag="h3">
                  {listaCvs.length+' Viviendas, '+habitantes+' Habitantes'}
                </CardTitle>
              </CardHeader>
              <CardBody>
                <div className="chart-area">
