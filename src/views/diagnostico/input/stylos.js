...
const InputXS = styled(InputR)`
  height: 25px !important;
  font-size: 10px;
  padding: 0 10 0 10px;
  border:none;
  border-bottom:1px solid ${colores.bordeXL} !important;
  color:${colores.color};
  transition: all .3s;
  border-radius:0;
  &:focus {
    border-bottom: 1px solid ${colores.colorFocus} !important;
    transition: 0.3s ease-in-out all;
  }
  ${(props) =>
    props.valido === "true" &&
...
const InputBuscador = styled.input` 
  ...
  transition: all .3s;
  &:focus {
    border: 1px solid ${colores.colorFocus};
    transition: 0.3s ease-in-out all;
  }
  ${(props) =>
    props.valido === "true" &&
